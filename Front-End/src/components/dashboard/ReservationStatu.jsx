          ...
          {LocalBookings && LocalBookings.length > 0 ? (
            LocalBookings.map((booking, index) => (
              <tr key={index} className="border-b border-slate-600">
                ...
                <td>
                  <h1 className={`cursor-pointer  p-1 rounded-full  flex items-center justify-center gap-1 
                  ${ booking.state == "Confirmed" ? "bg-green-500" : 
                    booking.state == "Deleted" ? "bg-red-500" : "bg-orange-400"
                   }`}>
                    <FontAwesomeIcon icon={booking.state == "Confirmed" ?
                      faCheckCircle :
